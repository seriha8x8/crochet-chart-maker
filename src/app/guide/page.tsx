      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-8">
        ...
        <GuideSection id="counter" title="カウンター" intro="編み物中に段数・目数・色替えなどをタップでカウントできるツールです。">
          ...
          <Feature title="タップでカウント">
            大きなタップゾーンをタップするたびに+1され、最終カウント日時も表示されます。数え間違えたときは、少し小さめの「−1」ボタンで1つ戻せます。ブラウザに自動保存されるので、ページを閉じたり読み込み直したりしても数字は消えません。ただしこの保存は端末（ブラウザ）ごとなので、ログインしていても別の端末やブラウザで開くとカウントは引き継がれません。
          </Feature>
        ...
        >
          ...
          <Feature title="配色パターンを見る">
            基準色と雰囲気から関連色を4色生成し、基準色と組み合わせた3色パターンを3種類表示します。各色はカラーコードで表示されるので、実際の毛糸選びの目安にできます。気に入らなければ「選び直す」で最初からやり直せます。
          </Feature>

          <Feature title="この配色に近い毛糸">
            パターンの下に、生成された4色それぞれに近い毛糸を楽天市場から自動で探して表示します。商品画像・価格つきのカードから、そのまま購入ページに進めます。近い商品が見つからない色は「近い商品が見つかりませんでした」と表示されます。
          </Feature>
        </GuideSection>
      </main>
